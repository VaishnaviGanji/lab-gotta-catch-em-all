...
public class PokemonController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (value2 != null) {
			...
			Charizard charizad = new Charizard("Charizard", 006, 
			...
			msg = "<center>" + charizad.getPokemonName() + "  #" + charizad.getPokemonNumber();
			request.setAttribute("message2", msg);
			request.setAttribute("character2", charizad.getCharacteristics());
			request.setAttribute("type2", charizad.getType());
			request.setAttribute("evolution2", charizad.getEvolution());
			request.setAttribute("baseExp2", charizad.getBaseExp());
		}
